      ...
      {success ? (
        ...
        <Box display="flex" justifyContent="center" sx={{ minHeight: "100vh", bgcolor: "#41729F" }}>
          <Stack
            ...
            <p className={errMsg ? "errmsg" : "offscreen"}>{errMsg}</p>
            <h1>Sign In</h1>
            <form style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: 'center' }} onSubmit={handleSubmit} noValidate autoComplete='off'>
              ...
              <Button
                sx={{ mt: '2rem', bgcolor: "#5885AF", width: '5rem' }}
                variant="contained"
                type="submit"
              >Submit
              </Button>
